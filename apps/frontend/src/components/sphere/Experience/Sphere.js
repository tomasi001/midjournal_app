...
export default class Sphere {
  ...
  setLights() {
    ...
    // Base
    this.lights.base = {};
    this.lights.base.color = {};
    // this.lights.base.color.value = "#e6dbf0";
    // this.lights.base.color.value = "#f2edf7";
    // this.lights.base.color.value = "#e8e8e8";
    this.lights.base.color.value = "#e6e6e6";
    this.lights.base.color.instance = new THREE.Color(
      this.lights.base.color.value
    );
    ...
    // Debug
    if (this.debug) {
      const baseDebugFolder = this.debugFolder.addFolder({
        title: "base",
      });
      baseDebugFolder
        .addInput(this.lights.base.color, "value", { view: "color" })
        .on("change", () => {
          this.lights.base.color.instance.set(this.lights.base.color.value);
        });

      for (const _lightName in this.lights) {
        if (_lightName === "base") continue;
  ...
  setMaterial() {
    this.material = new THREE.ShaderMaterial({
      uniforms: {
        uBaseColor: { value: this.lights.base.color.instance },
